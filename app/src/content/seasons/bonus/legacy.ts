import type { Motif, QuizQuestion, SceneConfig, StoryChoice } from '../../types';

/**
 * Conteúdo do MVP, no schema antigo (`theme` em vez de `valor`, `pages` sem
 * variante por faixa etária). É adaptado para o schema atual em `./index.ts`.
 *
 * Não edite este arquivo para criar conteúdo novo — histórias novas nascem
 * direto no schema atual, uma por arquivo, em `seasons/<livro>/`.
 */
...
export const LEGACY_STORIES: LegacyStory[] = [
  // ============================================================
  // 1. DAVI E GOLIAS
  // ============================================================
  {
